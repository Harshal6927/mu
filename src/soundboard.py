...
class Soundboard:
    ...
    def _create_hotkey_handler(self, sound_name: str):
    ...
    def list_sounds(self):
        ...
        table = Table(
            title="Available Sounds", show_header=True, header_style="bold cyan"
        )
    ...
    def list_hotkeys(self):
        ...
        table = Table(
            title="Hotkey Bindings", show_header=True, header_style="bold cyan"
        )
        table.add_column("Hotkey", style="green", justify="center")
        table.add_column("Sound Name", style="white")
